...
one number I already knew about, found exactly one more contaminated trace - this specific run, no others. Twenty-seven of the twenty-nine remaining
...
being rigorous - scan for the one contamination pattern I already knew - was *itself* a smaller version of the same mistake: checking for what I
